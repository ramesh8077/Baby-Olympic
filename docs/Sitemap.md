...
★	Campaign Landing Page	/lp/register	Hero + form above the fold · Trust bar · Why participate · Age bands · What every child gets · Guests · FAQ (short) · Sticky Register button	Register Now	
					
NOTE: The Campaign Landing Page is a trimmed version of Home built for paid ad traffic — one screen, one goal (register). Keep navigation minimal so the only real action is the form.
